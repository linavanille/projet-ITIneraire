...
- Analyse statistique et calibration des mesures
- Traitement de données brutes
- Développement d’une application utilisateur
...
- Utilisation de différents capteurs (GPS, etc.)
- Mise en place d’un système d’acquisition via Raspberry Pi
- Analyse de la précision et des erreurs

2. Traitement des données
- Études statistiques pour calibrer les capteurs
- Nettoyage et correction des données brutes
- Développement d’algorithmes de traitement
...
2. Analyse statistique pour évaluer précision et erreurs  
3. Calibration des capteurs  
4. Développement d’algorithmes de traitement  
