\section{RPLIDAR A1M8}

\vspace{2em}

\subsection{Description et fonctionnement}

Le RPLIDAR A1M8 est un capteur LiDAR 2D capable de scanner à 360\degre{} dans un plan horizontal. Il utilise un laser infrarouge de classe 1 (sans danger pour l’œil) et fonctionne par triangulation optique : il envoie un faisceau laser et calcule la distance à l’obstacle en analysant l’angle de retour.

\vspace{1em}

Il fournit environ 1450 mesures par tour, avec une résolution proche de 1\degre{} et une fréquence de scan autour de 5{,}5~Hz. On peut aussi augmenter la vitesse de rotation (jusqu’à 10~Hz) en réduisant le nombre de points. Sa portée utile est d’environ 6~mètres, avec un maximum pouvant atteindre 12~mètres selon les versions.
